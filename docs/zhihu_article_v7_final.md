...
<!-- 插入图1: 三层闭环架构 (fig1_architecture.svg) -->
...
<!-- 插入图2: DID绑定关系 (fig2_did_binding.svg) -->
...
<!-- 插入图3: 跨端鉴权流程 (fig3_auth_flow.svg) -->
...
<!-- 插入图4: 身份同步机制 (fig4_sync_mechanism.svg) -->

**图4**展示了身份同步引擎的工作原理（心跳协议 + 失联检测 + 广播机制）。
...
<!-- 插入图5: M6端到端验证流程 (fig5_demo_flow.svg) -->
